...
//		"bgcolor_override"	"0 0 0 240"
	...
	"testbackground" // how can you have multiplu images here? or tell the game that its meet your match update 24/7
	{
...
//		"image"			"../console/title_team_heavy01_blu_widescreen" "../console/title_team_heavy01_red_widescreen" "../console/title_team_pyro01_blu_widescreen" "../console/title_team_pyro01_red_widescreen" "../console/title_team_competitive_widescreen"
	...
	"Background" // this is used for halloween and christmas
	{
		"ControlName"	"ScalableImagePanel"
	...
	"MOTD_Panel"
	{
		...
		"MOTD_TitleImageContainer"
		{
			...
			"MOTD_TitleImage1"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/clown_sdk" // class_icons/filter_all
				"scaleImage"	"1"
			}
		}
		...
		"MOTD_TextScroller"
		{
			...
			"xpos"			"20"
			"ypos"			"215" // 215 image - 65 no image
			"wide"			"280"
			"tall"			"115" // 115 image - 265 no image
			"PaintBackgroundType"	"2"
			"fgcolor"		"LabelDark"
			...
			"MOTD_TextPanel"
			{
				...
				"MOTD_TextLabel"
				{
					...
					"font"			"HudFontSmall"
					"labelText"		"2124312431243rf !!! If you see this then I forgot to edit the MotD panel !!! これを見たら、MotDパネルを編集し忘れたことになります !!!"
					"textAlignment"	"north-west"
					"xpos"			"0"
					"ypos"			"0"
					"wide"			"250"
