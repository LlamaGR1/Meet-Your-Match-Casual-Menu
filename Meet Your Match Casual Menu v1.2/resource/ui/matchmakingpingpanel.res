...
{										// now that i think about it, does anyone even use the matchmaking settings? or was this a waste of time?
	...
	// VGUI is weird and makes some checkboxes have their text lower than it's supposed to be		valve is a circus
	// and the above checkbox has that behavior.  To get around it, make another label				and the developers the clowns
	"CheckLabel"
	{
		"ControlName"		"Label"
