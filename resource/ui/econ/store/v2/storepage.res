"Resource/UI/StorePage.res"
{
	...
	"SortExplanation"
	{
		...
		"TextLabel"
		{
			...
			"fieldName"		"TextLabel"
			"font"			"HudFontSmall"
			"labelText"		"If you're looking for specific items, you can Search directly, Sort by Newest, Oldest, Price, Alphabetically, or filter by Item Type."
			"textAlignment"	"north-west"
			"xpos"			"20"
			"ypos"			"45"
			"wide"			"260"
